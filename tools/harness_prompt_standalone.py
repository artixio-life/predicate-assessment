...

{
  ...
  "product_data": {
    ...
    "presentations": [{"per_value": "CONCENTRATION DENOMINATOR ONLY, for liquids/injectables where strength is stated per volume — '4 mg/2 mL' -> per_value=2, per_unit='mL'. NEVER a pack size or tablet count: a box of 20 tablets is NOT per_value=20, it is per_value=null (the count belongs in pack_size below)"|number|null, "per_unit": "e.g. 'mL' — null for solid oral forms"|null, "pack_size": "how many units the pack contains, e.g. 10 for a box of 10 tablets, 1 for a single ampoule. One presentation entry per distinct pack size"|number|null, "pack_unit": "what pack_size counts, lowercase and SINGULAR — 'tablet' not 'tablets', 'ampoule' not 'ampoules'. Other examples: 'capsule', 'vial', 'sachet', 'syringe', 'bottle'. Always a countable dosage-unit noun, NEVER a volume or weight unit (mL/L/g/mg)"|str|null, "form": str|null, "route": str|null, "active_ingredients": [{"substance": "English, base form not salt", "strength_value": number|null, "strength_unit": str|null, "salt": {"substance": str, "value": number, "unit": str}|null}]}],
